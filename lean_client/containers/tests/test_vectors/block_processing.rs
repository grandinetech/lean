...
// use a wrapper format (e.g., "validators": {"data": [...]}) that doesn't match
// the Rust deserializer expectations (which expects a direct list).
// The test vectors need to be regenerated by leanSpec to match the expected format,
// or the deserialization logic needs to be updated.
