...
fn test_process_slot() {
    ...
    assert_eq!(genesis_state.latest_block_header.state_root, ssz::H256::zero());
...
fn test_process_slots() {
    ...
    assert_eq!(new_state.latest_block_header.state_root, genesis_state.hash_tree_root());
}
...
fn test_process_block_header_valid() {
    ...
    assert_eq!(new_state.latest_block_header.state_root, ssz::H256::zero());
}

#[rstest]
#[case(2, 1, None, "Block slot mismatch")]
#[case(1, 2, None, "Incorrect block proposer")]
#[case(1, 1, Some(ssz::H256::from_slice(&[0xde; 32])), "Block parent root mismatch")]
